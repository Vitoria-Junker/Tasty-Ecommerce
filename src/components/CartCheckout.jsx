...
export default function CartCheckout () {
    return (
        ...
        <div className="h-screen grid grid-cols-3">
          <div className="lg:col-span-2 col-span-3 bg-easy/20 space-y-8 px-12 py-6">
           <Delivery />
           <Payment />           
            <button className="submit-button px-4 py-3 rounded-full bg-easy hover:bg-medium text-white focus:outline-none w-full text-xl font-semibold transition-colors">
              Pay €846.98
            </button>
          </div>
